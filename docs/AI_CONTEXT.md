...
- Os perfis e a política de autorização estão em `docs/AUTORIZACAO.md`; a base de autenticação está em `docs/AUTENTICACAO.md`; integração da identidade com RLS e telas ainda serão implementadas.
